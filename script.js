...
// body is not necessary here ... the DOM already has document.body as a default node (https://developer.mozilla.org/en-US/docs/Web/API/Document/body)
...
function setResults(catName, imgSrc, imgCredit) {
	resultCatName.innerText = catName;
	resultsImage.src = imgSrc;
	imgCredit.href = imgCredit;
}
...
function submitButtonClick() {
	...
	if (finalResult === 'AAAAA') {
		...
		imgCredit.href =
			'https://cattime.com/cat-breeds/balinese-cats#/slide/1';
		...
		imgCredit.href =
			'https://www.veterinarians.com/features/a-guide-to-the-ocicat-cat';
		...
		imgCredit.href =
			'https://www.pinterest.com/pin/178384835223540580/?lp=true';
	} else if (finalResult === 'BBABA') {
		resultCatName.innerText = 'Chartreux';
		resultsImage.src = 'elements/Chartreux.png';
		imgCredit.href =
			'https://www.petsbest.com/blog/cat-breed-guide-chartreux/';
		...
		imgCredit.href =
			'https://www.gccfcats.org/Breeding-Information/Analysis-of-Breeds-Registered';
